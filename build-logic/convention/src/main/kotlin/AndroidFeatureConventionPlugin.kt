    ...
    override fun apply(target: Project) {
        with(target) {
            ...
            dependencies {
                ...
                add("implementation", libs.findLibraryString("android.navigation3.runtime"))
                add("implementation", libs.findLibraryString("android.navigation3.ui"))
                add("implementation", libs.findLibraryString("android.lifecycle.viewmodel.navigation3"))
                add("implementation", libs.findLibraryString("android.material3.adaptive.navigation3"))
